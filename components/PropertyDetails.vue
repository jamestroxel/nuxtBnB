...
<div class="app-wrapper">
    <div class="app-double-column app-propoerty-details">
        <div>
            <h1>{{home.title}}</h1> 
            <div class="app-flex">
            ...
            <div class="app-property-details-footer">
                {{ pluralize(home.guests, 'guest') }} &middot; {{ pluralize(home.bedroooms, 'rooms') }} &middot; {{ pluralize(home.beds, 'bed') }} &middot; {{ pluralize(home.bathrooms, 'bath') }}
            </div>
        </div>
        <div>
            <div class="app-price">
